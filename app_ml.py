...
st.set_page_config(page_title="Recomendaciones Mercado Libre")
...
st.title("Ofertas Mercado Libre")

# Agrega el logo
url_imagen = "https://cccasanare.co/wp-content/uploads/2024/01/mercado-libre.png" 
st.image(url_imagen, width=120)  # Ajusta el ancho según sea necesario
